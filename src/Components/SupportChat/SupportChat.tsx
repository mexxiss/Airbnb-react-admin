    ...
    <div>
      <div className="px-6 pt-6 h-[calc(100vh_-_81px)] overflow-y-auto pb-6">
        <div className="flex items-center justify-between mb-5">
          ...
          <Link
            to={`/admin/user/679213726d1fcbe702f0b168`}
                  ...
                  <td className="py-3 px-3 w-[400px]">
                    <span className="text-sm text-text3 text-center">
                      <EllipsisTooltip
                        ...
                        title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium nostrum explicabo distinctio modi quos nisi ipsum ratione laborum obcaecati ea veniam, vitae autem, iure quisquam dolores nulla asperiores magni omnis!"
                      />
                    </span>
                  </td>
        ...
        >
          <Modal.Body className="!p-0">
            <div className="flex items-center justify-between px-5 py-3">
              <h6 className="text-lg font-medium text-primary">Reply</h6>
              ...
              <div className="">
                <div>
                  <p className="text-sm lg:text-base text-text3">
                    <span className="text-text1 font-medium">Type:</span>{" "}
                    General Question
                  </p>
                </div>
                <div className="mt-2">
                  <p className="text-sm lg:text-base text-text3">
                    <span className="text-text1 font-medium">Question:</span>{" "}
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Praesentium nostrum explicabo distinctio modi quos nisi
                    ipsum ratione laborum obcaecati ea veniam, vitae autem, iure
                    quisquam dolores nulla asperiores magni omnis!
                  </p>
                </div>
                <div className="mt-5">
                  <textarea
                ...
                <div className="mt-2 text-end">
                  <button className="btn1 rounded-full h-10 !px-8 tracking-wider">
                    Submit
                  </button>
                </div>
              </div>
