      ...
      <div className="px-6 pt-6 h-[calc(100vh_-_81px)] overflow-y-auto pb-10">
        <div>
          ...
          <p className="text-lg text-[#040404] font-medium mt-5">
            Total Properties {!filteredSortedProperties?.length ? "" : <span>({data?.totalProperties})</span>}
          </p>
          ...
          <div className="mt-4 sm:mt-0">
            {!filteredSortedProperties?.length ?
              <div className="w-full relative z-10 flex items-center justify-center pt-10"><p className="text-2xl sm:text-3xl text-gray-500 font-medium">No Property Found</p></div>
              :
              <>
