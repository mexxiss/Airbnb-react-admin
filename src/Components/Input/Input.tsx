    ...
    <div className="">
      {!!label && (
        <label
          className={classNames(
            "text-[15px] text-[#040404] mb-2 inline-block",
            labelClass
          )}
        >
          {label}
      ...
      <div className="relative">
        <input
          ...
          className={classNames(
            `${
              type === "password" ? "pr-10 pl-4" : "px-4"
            } py-3 leading-4 text-gray-600 placeholder:text-[#8B8B8B] border-[#c3c3c7] w-full rounded bg-[#F7F8FF]`,
            inputClass
          )}
        ...
        {type === "password" && (
          <span
            className="cursor-pointer absolute right-4 top-1/2 -translate-y-1/2 text-[#8B8B8B]"
