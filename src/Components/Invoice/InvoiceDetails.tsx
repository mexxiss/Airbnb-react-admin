    ...
    <div>
      <div className="px-6 lg:px-10 py-[32px] flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <Link to={"/admin/invoices"} className="text-22 text-primary">
            Invoice List
          </Link>
                  ...
                  <div className="grid md:grid-cols-2 gap-x-6 gap-y-8">
                    ...
                    <div>
                      <div className="text-gray-800 text-sm">
                        ...
                        <p className="mt-1">
                          18605 Thompson Circle Apt. 086 - Idaho Falls, WV /
                          50337
                        </p>
                        <div className="flex mt-1 gap-2">
                          <span className="font-medium">Phone:</span>
                          ...
                          <td colSpan={2} className="py-4 px-3">
                            ...
                            <ul className="mt-1 text-sm list-disc pl-4 flex flex-col gap-1">
                              <li>
                                ...
                                <span>DET lock</span>, <span>Decorations</span>,{" "}
                                <span>Laundry kit</span>
                              </li>
                              <li>
